  ...
  <el-row class="warp">
    <el-col :span="24" class="warp-breadcrum">
      <el-breadcrumb separator="/">
        ...
        <el-breadcrumb-item>家庭游戏管理</el-breadcrumb-item>
    ...
    <el-col :span="24" class="warp-main" v-loading="loading" element-loading-text="拼命加载中">
      ...
      <el-col :span="24" class="toolbar" style="padding-bottom: 0px;">
        <el-form :inline="true" :model="filters">
          <el-form-item>
            <el-input v-model="filters.name" placeholder="游戏名称" @keyup.enter.native="handleSearch"></el-input>
          </el-form-item>
          <el-form-item>
      ...
      <el-table :data="books" highlight-current-row @selection-change="selsChange"
        ...
        <el-table-column prop="name" label="游戏名称" sortable></el-table-column>
        <el-table-column prop="author" label="发行人" width="100" sortable></el-table-column>
        <el-table-column prop="publishAt" label="发行日期" width="150" sortable></el-table-column>
      ...
      <el-dialog title="编辑" :visible.sync ="editFormVisible" :close-on-click-modal="false">
        <el-form :model="editForm" label-width="100px" :rules="editFormRules" ref="editForm">
          ...
          <el-form-item label="发行人" prop="author">
