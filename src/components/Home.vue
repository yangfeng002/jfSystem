  ...
  <el-row class="container">
    ...
    <el-col :span="24" class="topbar-wrap">
      ...
      <div class="topbar-title">
       <!-- <span><img src="../assets/logotitle.png" alt=""></span>-->
        <span style="font-size: 18px;color: #fff;">经分后台管理系统</span>
      </div>
      <div class="topbar-account topbar-btn">
        <el-dropdown trigger="click">
          ...
          <el-dropdown-menu slot="dropdown">
            ...
            <el-dropdown-item>
              <div @click="jumpTo('/settings/changepwd')"><span style="color: #555;font-size: 14px;">修改密码</span></div>
            </el-dropdown-item>
...
<script>
  ...
  export default {
    ...
    created(){
      ...
      bus.$on('goto', (url) => {
        if (url === "/login") {
          localStorage.removeItem('access-manageboard');
        }
    ...
    mounted() {
      let user = localStorage.getItem('access-manageboard');
      if (user) {
